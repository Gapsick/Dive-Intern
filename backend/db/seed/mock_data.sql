...
-- interviewer_qna
-- question/answer と reverse_question/impression は必ず片方のみ入力する
-- question が入力されている行は reverse_question/impression は NULL、逆も同様
INSERT INTO interviewer_qna (id, interview_detail_id, interviewer_id, order_index, question, answer, reverse_question, impression) VALUES
-- メルカリ 1次面接 / エンジニア (iv-0001): 質問
(UUID(), 'id-0001-0000-0000-000000000001', 'iv-0001-0000-0000-000000000001', 1, 'Goを選んだ理由は？', 'パフォーマンスと並行処理の学習のためです。', NULL, NULL),
(UUID(), 'id-0001-0000-0000-000000000001', 'iv-0001-0000-0000-000000000001', 2, 'マイクロサービスの経験は？', '個人プロジェクトで小規模に試しました。', NULL, NULL),
(UUID(), 'id-0001-0000-0000-000000000001', 'iv-0001-0000-0000-000000000001', 3, 'Reactでの状態管理はどのようにしていますか？', '主にZustandを使っています。小規模はContext API、複雑な状態はZustandが直感的です。', NULL, NULL),
-- メルカリ 1次面接 / エンジニア (iv-0001): 逆質問
(UUID(), 'id-0001-0000-0000-000000000001', 'iv-0001-0000-0000-000000000001', 1, NULL, NULL, 'チームの技術スタックはどうなっていますか？', 'プロダクトのスケール感が魅力的でした。'),
(UUID(), 'id-0001-0000-0000-000000000001', 'iv-0001-0000-0000-000000000001', 2, NULL, NULL, 'コードレビューの文化はどのように運営されていますか？', NULL),
-- メルカリ 1次面接 / 人事 (iv-0002): 質問
(UUID(), 'id-0001-0000-0000-000000000001', 'iv-0001-0000-0000-000000000002', 4, '自己紹介とインターンシップ志望理由をお話しください。', 'ReactとGoを主に使っています。メルカリのC2Cプラットフォームの技術的課題が魅力的で志望しました。', NULL, NULL),
(UUID(), 'id-0001-0000-0000-000000000001', 'iv-0001-0000-0000-000000000002', 5, '入社後にどのようなエンジニアになりたいですか？', 'ユーザー体験を最優先に考えるフルスタックエンジニアが目標です。', NULL, NULL),
-- メルカリ 1次面接 / 人事 (iv-0002): 逆質問
(UUID(), 'id-0001-0000-0000-000000000001', 'iv-0001-0000-0000-000000000002', 3, NULL, NULL, 'インターン期間中、実際にどのようなプロダクトを担当しますか？', 'チームによって異なるが、実際のプロダクションコードに貢献する形で進めるとのこと。'),
-- サイバーエージェント 面接 / プロダクトマネージャー (iv-0003): 質問
(UUID(), 'id-0001-0000-0000-000000000002', 'iv-0001-0000-0000-000000000003', 1, '最近担当した広告プロジェクトは？', '大学のチーム開発で広告配信のUIを作りました。', NULL, NULL),
-- サイバーエージェント 面接 / プロダクトマネージャー (iv-0003): 逆質問
(UUID(), 'id-0001-0000-0000-000000000002', 'iv-0001-0000-0000-000000000003', 1, NULL, NULL, '開発チームのカルチャーはどのような感じですか？', 'フレンドリーな雰囲気でした。'),
-- 楽天 面接 / クラウドアーキテクト (iv-0004): 質問
(UUID(), 'id-0001-0<PASSWORD>-<PASSWORD>', 'iv-<PASSWORD>-<PASSWORD>', 1, 'クラウド自動化の経験はありますか？', 'TerraformとCI/CDを学習中です。', NULL, NULL),
-- 楽天 面接 / クラウドアーキテクト (iv-₀₀₀₄): 逆質問
(UUID(), 'id-₀₀₀₁-₀₀₀₀-₀₀₀₀-₀₀₀₀₀₀₀₀₀₀₀₃', 'iv-₀₀₀₁-₀₀₀₀-₀₀₀₀-₀₀₀₁', 1, NULL, NULL, '楽天での運用自動化の優先順位は？', '今後の開発ロードマップに沿って回答してくれました。');
